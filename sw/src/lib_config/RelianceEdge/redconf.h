...
#define REDCONF_BLOCK_SIZE 256U
...
#define REDCONF_TRANSACT_DEFAULT (( RED_TRANSACT_CREAT | RED_TRANSACT_MKDIR | RED_TRANSACT_LINK | RED_TRANSACT_UNLINK | RED_TRANSACT_FSYNC | RED_TRANSACT_CLOSE | RED_TRANSACT_VOLFULL | RED_TRANSACT_UMOUNT | RED_TRANSACT_SYNC ) & RED_TRANSACT_MASK)
...
#define RED_CONFIG_UTILITY_VERSION 0x2030000U
